...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-head">
		...
		<div class="meta"> 
			...
			<span class="post-format <?php echo get_post_format(); ?>"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'rundown' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><img src="<?php echo get_template_directory_uri(); ?>/images/link.png" alt="<?php echo get_post_format(); ?>" /></a></span> 										
